...
public class CreateLeadAndDuplicateLead {
    public static void main(String[] args) throws InterruptedException {
        ...
        //Contact Information//
        chromeDriver.findElementById("createLeadForm_primaryPhoneCountryCode").sendKeys("12");
        chromeDriver.findElementById("createLeadForm_primaryPhoneAreaCode").sendKeys("123");
        chromeDriver.findElementById("createLeadForm_primaryPhoneNumber").sendKeys("1234");
